        ...
        $('.page-content-area').ace_ajax('loadScripts', scripts, function() {
        	...
        	jQuery(function($) {
        		...
        		jQuery(grid_selector).jqGrid({
        			subGrid : false,
        			url : "${contextPath}/sys/test/getTest",
        			datatype : "json",
        			height : 450,
        			colNames : ['', 'ID', '姓名', '生日', '工资'],
        			colModel : [ {
        				name : '',
        				index : '',
        				width : 80,
        			...
        			editurl : "${contextPath}/sys/test/operateTest"
        			//caption : "用户管理列表",
        			//autowidth : true,
        			/**
        			grouping : true, 
				...
				jQuery(grid_selector).jqGrid('navButtonAdd', pager_selector,{
			       ...
			       onClickButton : function () { 
			    	   ...
			    	   var form = "<form name='csvexportform' action='${contextPath}/sys/test/operateTest?oper=excel' method='post'>";
